namespace ex06_properties
{
    class Kituraim
    {
        ...
        // 생성자
        public Kituraim(int year, string name, int temperature)
        {
            Year = year;
            Name = name;
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // Console.WriteLine($"보일러의 온도는 {boiler.GetTemperature()}도");
            ...
            Kituraim kituraim = new Kituraim(name : "라미", temperature : 25, year : 2023);
            Console.WriteLine(kituraim.Name);
            Console.WriteLine($"제작년도 : {kituraim.Year}");
            kituraim.Temperature = 180;
            Console.WriteLine($"{kituraim.Name}의 현재온도는 {kituraim.Temperature}도");
        }
    }
}
