...
- **인터페이스**
    ...
    ![인터페이스설명](https://raw.githubusercontent.com/guswlrla/basic-csharp-2024/main/images/cs001.png)
...
- 토이 프로젝트
    - 윈도우 탐색기 앱
        ...
        ![중간결과](https://raw.githubusercontent.com/guswlrla/basic-csharp-2024/main/images/cs005.png)
...
- 토이 프로젝트
    - 윈도우 탐색기 앱 종료
        ...
        https://github.com/guswlrla/basic-csharp-2024/assets/158007465/4adede97-fedc-482f-9af8-4812dd33fb28

    - 도서관리 앱 with SQL Server(Base) ModernUI(NuGet패키지)
    ```cs
    // 값형식 변수에 null값을 넣을 수 있도록 만들어주는 기능 Nullable. 변수명 뒤에 ? 추가
    int? a = null;
    double? a = null;
    float? a = null;
    ````
...
- 토이 프로젝트
 ...
 - 토이 프로젝트
    - 기존 만들어진 폼을 복사해서 변경할 시
        - ***.cs에 있는 클래스명, 생성자, *.Designer.cs에 있는 클래스명** 3군데 이름 변경
    - 도서관리 앱
        - 공통 클래스...
        - 책장르 관리
        - 책정보 관리
