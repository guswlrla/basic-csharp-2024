...
namespace ex07_collections
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"배열의 기본타입 : {score.GetType().BaseType}");
            ...
            Console.WriteLine(Array.BinarySearch(score, 90)); // 4, 인덱스 4에 90이 존재함
            Console.WriteLine(Array.IndexOf(score, 90)); // 4, 인덱스 4에 90이 존재함

            // 배열분할. C# 8.0부터 파이썬 배열 슬라이스기능 도입
            char[] array2 = new char[26]; // [26]대신 ['Z' - 'A' + 1] 가능, (96 - 65 + 1)
            ...
            Console.WriteLine(); // 이렇게 복잡하게 할 필요x, Console.WriteLine(array2);로 가능
            ...
            // Stack과 Queue,  Python 자료구조에 배웠던 스택, 큐랑 차이없음
    ...
    class CustomEnumerator
    {
        ...
        // foreach로 사용할 수 없는 객체를 반복문 쓸 수 있도록 만들어 주는 것
