namespace ex10_delegators
{
    ...
    class EventListener // 이벤트가 발생하는지 듣고있는 객체
    {
        ...
        {
            Console.WriteLine($"{name}.무슨 일이 발생했다!!! : {message}");
        }
    }
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // 대리자 체인!! notifier의 EventOccured라는 대리자에 리스터 3개에 일어날 수 있는 메서드를 연결
            // 일반적인 함수 호출에서 한번에 여러개의 함수 실행이 가능한가? 불가능!
            ...
            notifier.EventOccured -= listener2.SomethingHappened; // 리스너 2번의 함수는 실행x
